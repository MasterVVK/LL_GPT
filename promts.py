class Promt:
    ...
    replace_dict = {"Разработчик":"Программист, разработчик программного обеспечения на языке программирования",
                    ...
                    "Сисадмин": "системный администратор, системный инженер",
                    "Тестировщик":"тестировщик программного обеспечения, QA",
                    "open":"открытые вопросы",
                    "close":"закрытые вопросы с вариантами ответов",
                    }
...
Вопрос должен быть таким, чтобы ответ специалиста мог продемонстрировать его практический опыт.'''
                }
